        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="certForm" action="${APP_PATH}/cert/update.do" method="post">
				  <input type="hidden" name="id" value="${cert.id}">
				  <div class="form-group">
					<label for="exampleInputEmail1">资质名称</label>
					<input type="text" class="form-control" id="fname" value="${cert.name}" name="name" placeholder="请输入资质名称">
				  </div>
<!-- 				  <div class="form-group">
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	var fname = $("#fname");
			    	if ( fname.val() == "" ) {
						layer.msg("资质名称不能为空，请输入", {time:1500, icon:6, shift:6}, function(){
							fname.focus();
						});
						return;
			    	}
			    	...
			    	$("#certForm").ajaxSubmit({
			    		...
			    		success : function(r) {
			    			...
			    			if ( r.success ) {
		    					...
		    					layer.msg("资质信息修改失败", {time:1500, icon:5, shift:6}, function(){
