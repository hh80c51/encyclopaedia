 ...
 <div class="navbar-wrapper">
      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="fcheckcode" name="checkcode" placeholder="请输入认证码">
		  </div>
	...
	<script>
        ...
        $("#nextBtn").click(function(){
            ...
            if ( fcheckcode.val() == "" ) {
				layer.msg("认证码不能为空，请输入", {time:1500, icon:5, shift:6}, function(){
					fcheckcode.focus();
				});
                return;
            }
            ...
            $.ajax({
                type : "POST",
                url  : "${APP_PATH}/member/checkCode.do",
                data : {
                   "code" : fcheckcode.val()
                },
                success : function(r) {
                    if ( r.success ) {
						...
						layer.msg("认证码验证失败", {time:1500, icon:5, shift:6});
                    }
                }
            });
        });
