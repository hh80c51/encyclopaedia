        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="permissionForm" action="${APP_PATH}/permission/insert.do" method="post" role="form">
				  <input type="hidden" name="pid" value="${param.id}">
				  <div class="form-group">
					<label for="exampleInputEmail1">许可名称</label>
					<input type="text" class="form-control" id="fname" name="name" placeholder="请输入许可名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">链接地址</label>
					<input type="text" class="form-control" id="furl" name="url" placeholder="请输入链接地址">
				  </div>
<!-- 				  <div class="form-group">
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#insertBtn").click(function(){
			    	...
			    	var fname = $("#fname");
			    	if ( fname.val() == "" ) {
						layer.msg("许可名称不能为空，请输入", {time:1500, icon:5, shift:6}, function(){
							fname.focus();
						});
						return;
			    	}
			    	...
			    	var furl = $("#furl");
			    	if ( furl.val() == "" ) {
						layer.msg("链接地址不能为空，请输入", {time:1500, icon:5, shift:6}, function(){
							furl.focus();
						});
						return;
			    	}
			    	...
			    	$("#permissionForm").ajaxSubmit({
			    		...
			    		success : function(r) {
			    			...
			    			if ( r.success ) {
			    				window.location.href = "${APP_PATH}/permission/list.htm";
			    			} else {
		    					layer.msg("许可信息保存失败", {time:1500, icon:5, shift:6}, function(){
