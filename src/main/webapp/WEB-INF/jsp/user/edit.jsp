        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="userForm" action="${APP_PATH}/user/update.htm" method="post" role="form">
				  <input type="hidden" name="id" value="${user.id}">
				  <div class="form-group">
					<label for="exampleInputEmail1">登陆账号</label>
					<input type="text" class="form-control" id="floginacct" name="loginacct" value="${user.loginacct}" placeholder="请输入登陆账号">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">用户名称</label>
					<input type="text" class="form-control" id="fusername" name="username" value="${user.username}" placeholder="请输入用户名称">
				  </div>
<!-- 				  <div class="form-group">
					...
					<textarea rows="" cols="" >123123213213213</textarea>
				  </div> -->
<!-- 				  <div class="form-group">
			    	...
			    	$("#userForm").ajaxSubmit({
			    		...
			    		success : function(r) {
			    			...
			    			if ( r.success ) {
		    					...
		    					layer.msg("用户信息修改失败", {time:1500, icon:5, shift:6}, function(){
