	...
	<script src="${APP_PATH}/jquery/jquery.pagination.js"></script>
        <script type="text/javascript">
			    	...
			    	success : function(r) {
			    		...
			    		if ( r.success ) {
			    			...
			    			$.each(datas, function(index, role){
				                ...
				                content += '  <td>';
								content += '      <button type="button" onclick="window.location.href=\'${APP_PATH}/role/assign/'+role.id+'.htm\'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
	    					...
	    					layer.msg("角色信息分页查询失败", {time:1500, icon:5, shift:6}, function(){
    				...
    				$.ajax({
    					...
    					success : function(r) {
    						...
    						if ( r.success ) {
    	    					...
    	    					layer.msg("角色信息删除失败", {time:1500, icon:5, shift:6}, function(){
            ...
            function deleteRoles() {
            	...
            	if ( boxes.length == 0 ) {
					layer.msg("请选择需要删除的角色信息", {time:1500, icon:5, shift:6}, function(){
