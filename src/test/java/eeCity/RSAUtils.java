...
public class RSAUtils {
    ...
    private static final String PUBLIC_FILENAME = "hk_publicKey.properties";
    private static final String PRIVATE_FILENAME = "hk_privateKey.properties";
    /** 密钥对生成器 */
    ...
    private static String getKeyString(String keyName,String fileName){
        System.out.println("keyString：" + RSAUtils.class.getClassLoader().getResource(fileName));
    ...
    public static RSAPrivateKey getPrivateKey(){
        try {
            String privateKey = getKeyString(PRIVATE_KEY_NAME,PRIVATE_FILENAME);
     ...
     */
    public static String sha256X16(String data, String encoding) throws Exception {
    ...
    */
    public static  byte[] sign(String sign_str) {
        byte[] signed = null;
        try {
            Security.addProvider(new BouncyCastleProvider());
            Signature pss = Signature.getInstance("SHA256withRSA/PSS",new BouncyCastleProvider());
            PrivateKey privateKey = getPrivateKey();
            pss.initSign(privateKey);
            pss.update(sign_str.getBytes("UTF-8"));
            signed = pss.sign();
        }catch (Exception e) {
            e.printStackTrace();
        }
